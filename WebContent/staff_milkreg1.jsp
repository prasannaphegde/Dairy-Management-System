...
<body>             <button    > <B><a href="stafffeat1.html">BACK</B> </a></button>

 <form action="staff_milkreg1.jsp" method="post">
...
if(  sup_id!=null && fat!=null && price!=null && quantity!=null ){

if(  sup_id!="" && fat!="" && price!="" && quantity!="") {
